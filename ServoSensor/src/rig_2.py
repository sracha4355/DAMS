    ...
    while True:
        ...
        if count > 8:
            ...
            if recv[0] == 0x59 and recv[1] == 0x59:     #python3
                ...
                if lower_bound <= distance * math.sin(math.radians(angle)) <= upper_bound:
                    points.append([angle,distance * math.sin(math.radians(angle))])
                else:
                    print('filtered at angle', angle)
...
data = {"xpoints":xpoints, "ypoints":ypoints}
